<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HODLogin.aspx.cs" Inherits="College_Grievance_Cell.HODLogin" %>
...
<body>
    <form id="form1" runat="server">
        <div align="center">
                 <asp:Label ID="Label1" runat="server" ClientIDMode="Predictable" Font-Bold="True" Font-Size="XX-Large" Text="HOD Login Page"></asp:Label>
                <br />
                <br />
                <br />
